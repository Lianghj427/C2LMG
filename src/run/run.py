...
def run_sequential(args, logger):
    ...
    while runner.t_env <= args.t_max:
        ...
        if args.save_model and (
            ...
            if args.save_model_type == "all":
                type_t = str(runner.t_env)
            elif args.save_model_type == "latest":
                type_t = str(0)
            elif args.save_model_type == "best":
                # TODO: fix the logit of saveing the best model
                pass
            else:
