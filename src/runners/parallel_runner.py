...
class ParallelRunner:
    ...
    def run(self, test_mode=False):
        ...
        # if 0 in episode_lengths:
        #     raise ValueError("Variables episode_lengths includes 0. Division by 0 is not allowed.")
        # episode_returns = [episode_return / episode_length for episode_return, episode_length in zip(episode_returns, episode_lengths)]
